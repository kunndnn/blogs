  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-8 grid lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-8 space-y-6">
        <h2 className="text-3xl font-bold mb-4">Get started with docker</h2>
        <p>This blog explains how to setup docker.</p>

        {step(1)}
        <p>Install the docker from <a href="https://docs.docker.com/desktop" className='text-blue-500' target='_blank'>https://docs.docker.com/desktop</a> for your desired platform.</p>
        ...
        <h3 className='mt-8 text-2xl font-semibold scroll-mt-24' id='step-3'> Create a docker image of the project</h3>
        ...
        <p>
          <ul className='list-decimal ml-5'>
            <li>Go to <a href="https://hub.docker.com" target='_blank' className='text-blue-500'>https://hub.docker.com</a> .</li>
            <li>Log in.</li>
            ...
            <li>
              Go to <a href="https://hub.docker.com/repositories" target='_blank' className='text-blue-500'>https://hub.docker.com/repositories</a> → you should see your fastapi-backend repo with the latest tag.
        ...
        <h3 className='mt-8 text-2xl font-semibold scroll-mt-24' id='step-5'>Container commands</h3>
        ...
        <h3 className='mt-8 text-2xl font-semibold scroll-mt-24' id='step-6'>Images commands</h3>
