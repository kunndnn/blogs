import{j as t}from"./vendor-motion-BMzj7qdh.js";import{c as ie}from"./index-WZKFzEes.js";import{r as Ue}from"./vendor-router-7jSiYg31.js";import{F as Ge,a as ze}from"./index-BucHDtUe.js";const He=e=>{const s=ie.c(28),{parts:o,styles:n}=e;let r,l,i;s[0]!==o?(r=o===void 0?[]:o,l=Ue.useState,i=r?.map(Ae).filter(Boolean).reduce(Le,{}),s[0]=o,s[1]=r,s[2]=l,s[3]=i):(r=s[1],l=s[2],i=s[3]);const[a,d]=l(i),[c,u]=Ue.useState(!1);let m;s[4]===Symbol.for("react.memo_cache_sentinel")?(m=(v,f)=>{d(C=>({...C,[v]:f}))},s[4]=m):m=s[4];const h=m;let x;if(s[5]!==r||s[6]!==a){const v=()=>r?.map((f,C)=>f.type==="placeholder"?a[C]:f.text).join("");x=async()=>{try{await navigator.clipboard.writeText(v()),u(!0),setTimeout(()=>u(!1),2e3)}catch(f){console.error("Failed to copy:",f)}},s[5]=r,s[6]=a,s[7]=x}else x=s[7];const g=x,S=`relative w-full ${n??""}`,k=`w-full bg-background-surface text-green-400 p-4 rounded-2xl overflow-x-auto whitespace-pre-wrap break-words border border-border-soft shadow-xl ${n??""}`;let y;s[8]!==r||s[9]!==a?(y=r?.map((v,f)=>v?.type==="placeholder"?t.jsx("input",{value:a[f],onChange:C=>h(f,C.target.value),className:`\r
                    bg-background-elevated\r
                    text-brand-primary\r
                    font-bold\r
                    px-1\r
                    mx-1\r
                    rounded-md\r
                    border border-border-strong\r
                    focus:border-brand-primary/50 \r
                    focus:bg-background-surface\r
                    focus:outline-none\r
                    min-w-[2ch]\r
                    transition-all\r
                  `,size:a[f].length||4},f):t.jsx("span",{className:"opacity-90",children:v.text},f)),s[8]=r,s[9]=a,s[10]=y):y=s[10];let b;s[11]!==y?(b=t.jsx("code",{className:"leading-relaxed text-sm sm:text-base md:text-lg",children:y}),s[11]=y,s[12]=b):b=s[12];let j;s[13]!==k||s[14]!==b?(j=t.jsx("pre",{className:k,children:b}),s[13]=k,s[14]=b,s[15]=j):j=s[15];let _;s[16]!==c?(_=c?t.jsx(Ge,{className:"text-base sm:text-lg text-green-400"}):t.jsx(ze,{className:"cursor-pointer text-base sm:text-lg"}),s[16]=c,s[17]=_):_=s[17];let w;s[18]!==g||s[19]!==_?(w=t.jsx("button",{onClick:g,className:"absolute top-3 right-3 text-text-muted hover:text-text-main transition-all p-2 rounded-xl bg-background-elevated border border-border-soft backdrop-blur-md hover:bg-background-surface",children:_}),s[18]=g,s[19]=_,s[20]=w):w=s[20];let N;s[21]!==c?(N=c&&t.jsx("span",{className:"absolute -bottom-8 right-2 text-[10px] sm:text-xs text-brand-primary bg-brand-primary/10 border border-brand-primary/20 px-3 py-1 rounded-full backdrop-blur-md shadow-xl",children:"Copied!"}),s[21]=c,s[22]=N):N=s[22];let I;return s[23]!==j||s[24]!==w||s[25]!==N||s[26]!==S?(I=t.jsx(t.Fragment,{children:t.jsxs("div",{className:S,children:[j,w,N]})}),s[23]=j,s[24]=w,s[25]=N,s[26]=S,s[27]=I):I=s[27],I};function Ae(e,s){return e.type==="placeholder"?{[s]:e.text}:null}function Le(e,s){return{...e,...s}}function We(e){const s=ie.c(15),{src:o,alt:n,styles:r}=e,[l,i]=Ue.useState(!1);let a,d;s[0]!==l?(a=()=>{const g=document.body.style.overflow;return document.body.style.overflow=l?"hidden":g,()=>{document.body.style.overflow=g}},d=[l],s[0]=l,s[1]=a,s[2]=d):(a=s[1],d=s[2]),Ue.useEffect(a,d);const c=`mt-4 rounded-xl shadow-lg w-full max-w-[20rem] md:max-w-md cursor-pointer transition-transform hover:scale-[1.02] hover:shadow-xl ${r??""}`;let u;s[3]===Symbol.for("react.memo_cache_sentinel")?(u=()=>i(!0),s[3]=u):u=s[3];let m;s[4]!==n||s[5]!==o||s[6]!==c?(m=t.jsx("img",{src:o,alt:n,className:c,onClick:u,loading:"lazy"}),s[4]=n,s[5]=o,s[6]=c,s[7]=m):m=s[7];let h;s[8]!==n||s[9]!==l||s[10]!==o?(h=l&&t.jsx("div",{className:"fixed inset-0 z-60 flex items-center justify-center bg-black/70 backdrop-blur-md mb-0",onClick:()=>i(!1),children:t.jsxs("div",{className:"relative max-w-3xl max-h-[90vh] w-auto",onClick:Ve,children:[t.jsx("button",{onClick:()=>i(!1),className:"absolute -top-3 -right-3 bg-brand-primary text-white w-8 h-8 rounded-full hover:bg-brand-secondary transition cursor-pointer flex items-center justify-center text-sm font-bold shadow-lg z-10",children:"✕"}),t.jsx("img",{src:o,alt:n,className:"rounded-xl shadow-2xl max-w-sm md:max-w-full max-h-[90vh] object-contain",loading:"lazy"})]})}),s[8]=n,s[9]=l,s[10]=o,s[11]=h):h=s[11];let x;return s[12]!==m||s[13]!==h?(x=t.jsxs(t.Fragment,{children:[m,h]}),s[12]=m,s[13]=h,s[14]=x):x=s[14],x}function Ve(e){return e.stopPropagation()}const Je=e=>{const s=ie.c(5),{steps:o}=e;if(!o)return null;const n=Xe;let r;s[0]===Symbol.for("react.memo_cache_sentinel")?(r=t.jsxs("h3",{className:"text-xl font-bold mb-4 text-text-main flex items-center gap-2",children:[t.jsx("span",{className:"w-1.5 h-6 bg-brand-primary rounded-full shadow-[0_0_12px_rgba(99,102,241,0.5)]"}),"Quick Steps"]}),s[0]=r):r=s[0];let l;s[1]!==o?(l=o?.map((a,d)=>{const{name:c}=a;return t.jsxs("div",{className:"flex gap-4 group",children:[t.jsx("span",{className:"text-xs font-bold text-brand-primary/40 group-hover:text-brand-primary transition-colors shrink-0 mt-1.5 font-mono",children:String(d+1).padStart(2,"0")}),t.jsx("button",{onClick:()=>document.getElementById(`step-${d+1}`).scrollIntoView({behavior:"smooth"}),className:"text-text-muted group-hover:text-text-main hover:cursor-pointer text-left transition-all font-medium text-sm leading-relaxed w-full bg-transparent border-none p-0",children:n(c)})]},d)}),s[1]=o,s[2]=l):l=s[2];let i;return s[3]!==l?(i=t.jsxs("div",{className:"hidden lg:block lg:col-span-4 sticky top-24 space-y-6 h-fit pl-8 border-l border-border-soft",children:[r,t.jsx("div",{className:"space-y-4",children:l})]}),s[3]=l,s[4]=i):i=s[4],i};function Xe(e){return e.replace(/\s+/g," ").toLowerCase()}const Ye=e=>{const s=ie.c(3),{stepNum:o}=e,n=`step-${o}`;let r;return s[0]!==o||s[1]!==n?(r=t.jsxs("h3",{id:n,className:"mt-8 text-2xl font-semibold scroll-mt-24 text-text-main",children:["Step ",o,":"]}),s[0]=o,s[1]=n,s[2]=r):r=s[2],r},qe={Code:He,Image:We,Sidebar:Je,Step:Ye},Ke="/blogs/assets/image1-zbsltFLs.png",Qe="/blogs/assets/image2-ieO3mnVY.png",Ze="/blogs/assets/image3-D8_8r3db.png",{Code:Me,Image:Ee,Sidebar:et,Step:tt}=qe,st=[{name:"Create GitHub repository"},{name:"Install gh-pages"},{name:"Update vite.config.js"},{name:"Add deploy scripts"},{name:"Add homepage key"},{name:"Deploy project to github"}],rt=()=>{const e=ie.c(20),s=ot;let o,n,r,l,i,a;e[0]===Symbol.for("react.memo_cache_sentinel")?(o=t.jsx("h2",{className:"text-3xl font-bold mb-4 text-text-main",children:"Host React App with GitHub"}),n=t.jsx("p",{children:"This blog explains how to deploy a React app using GitHub Pages."}),r=s(1),l=t.jsx("p",{children:"Create a GitHub repository and set it as public."}),i=s(2),a=t.jsx("p",{children:"Now Install gh-pages package:"}),e[0]=o,e[1]=n,e[2]=r,e[3]=l,e[4]=i,e[5]=a):(o=e[0],n=e[1],r=e[2],l=e[3],i=e[4],a=e[5]);let d,c,u,m,h,x,g,S,k,y,b,j;e[6]===Symbol.for("react.memo_cache_sentinel")?(k=t.jsx(Me,{parts:[{type:"text",text:"npm install gh-pages"}]}),y=s(3),b=t.jsx("p",{children:"Now add your GitHub repository name in the vite.config.js file as base in config method as shown in the image below:"}),j=t.jsx(Ee,{src:Ke,alt:"Vite config"}),d=s(4),c=t.jsx("p",{children:"Now add predeploy and deploy scripts in package.json as shown in image below:"}),u=t.jsx(Ee,{src:Qe,alt:"package.json scripts"}),m=s(5),h=t.jsx("p",{children:"Now add homepage key in the package.json file and here add your github repo link replace username with your github username and github-repo-name with your github repository name:"}),x=t.jsx(Ee,{src:Ze,alt:"package.json homepage"}),g=s(6),S=t.jsx("p",{children:"After all the above steps now run the command : this command will create the build of the react app and then publish the code to the github pages section wait for few minutes."}),e[6]=d,e[7]=c,e[8]=u,e[9]=m,e[10]=h,e[11]=x,e[12]=g,e[13]=S,e[14]=k,e[15]=y,e[16]=b,e[17]=j):(d=e[6],c=e[7],u=e[8],m=e[9],h=e[10],x=e[11],g=e[12],S=e[13],k=e[14],y=e[15],b=e[16],j=e[17]);let _;e[18]===Symbol.for("react.memo_cache_sentinel")?(_=t.jsx(Me,{parts:[{type:"text",text:"npm run deploy"}]}),e[18]=_):_=e[18];let w;return e[19]===Symbol.for("react.memo_cache_sentinel")?(w=t.jsxs("div",{className:"max-w-7xl mx-auto px-6 py-8 grid lg:grid-cols-12 gap-8",children:[t.jsxs("div",{className:"lg:col-span-8 space-y-6",children:[o,n,r,l,i,a,k,y,b,j,d,c,u,m,h,x,g,S,_,t.jsxs("p",{children:["To access the live url of the web app visit the  ",t.jsx("a",{href:"https://username.github.io/github-repo-name",children:"https://username.github.io/github-repo-name ."}),"Replace the username with your github username and github-repo-name with your github repository name."]})]}),t.jsx(et,{steps:st})]}),e[19]=w):w=e[19],w};function ot(e){return t.jsx(tt,{stepNum:e})}const lt="/blogs/assets/thumbnail-OmwKpVef.png",nt="/blogs/assets/img1-DRbWAA7l.png",at="/blogs/assets/img2-C7k7KnTo.png",it="/blogs/assets/img3-p04h_RCf.png",ct="/blogs/assets/img4-BdtRDNgC.png",mt="/blogs/assets/img5-wx0Noo05.png",dt="/blogs/assets/img6-Bqy8jWQi.png",pt="/blogs/assets/img7-xCk9zIbi.png",xt="/blogs/assets/img8-C-6OjMyr.png",ht="/blogs/assets/img9-D2mdfoLD.png",{Code:re,Image:ne,Sidebar:ut,Step:ft}=qe,gt=[{name:"Install Node.js"},{name:"Create project directories"},{name:"Initialize node.js project"},{name:"create folder structures"},{name:"install dependencies/packages"},{name:"create db connection file"},{name:"create user model"},{name:"create controller"},{name:"create middleware"},{name:"create routes"},{name:"create index file"},{name:"setup environmental variables"},{name:"run the project"}],ae={versionCheck:`node -v
npm -v
...
`,mongoURI:"mongodb://localhost:27017"},yt=()=>{const e=ie.c(54),s=bt;let o,n,r,l;e[0]===Symbol.for("react.memo_cache_sentinel")?(o=t.jsx("h2",{className:"text-3xl font-bold mb-4 text-text-main",children:"Node.js project structure"}),n=t.jsx("p",{children:"This blog explains how to setup the Node.js project structure."}),r=s(1),l=t.jsx("p",{children:"Install Node.js"}),e[0]=o,e[1]=n,e[2]=r,e[3]=l):(o=e[0],n=e[1],r=e[2],l=e[3]);let i;e[4]===Symbol.for("react.memo_cache_sentinel")?(i=t.jsxs("li",{children:["Download and install",t.jsx("a",{className:"cursor-pointer mx-1 text-brand-primary hover:text-brand-secondary underline decoration-brand-secondary",onClick:jt,children:"Node.js"}),"(LTS version recommended)."]}),e[4]=i):i=e[4];let a,d,c;e[5]===Symbol.for("react.memo_cache_sentinel")?(a=t.jsxs("ul",{className:"list-disc ml-5",children:[i,t.jsxs("li",{children:["Verify installation",t.jsx(re,{parts:[{type:"text",text:ae?.versionCheck}]}),t.jsx(ne,{src:nt,alt:"node & npm versions"})]})]}),d=s(2),c=t.jsx("p",{children:"Create a Project Directory."}),e[5]=a,e[6]=d,e[7]=c):(a=e[5],d=e[6],c=e[7]);let u,m,h;e[8]===Symbol.for("react.memo_cache_sentinel")?(m=t.jsx(re,{parts:[{type:"text",text:"mkdir my-node-app"},{type:"text",text:`
`},{type:"text",text:"cd my-node-app"}]}),h=s(3),u=t.jsx("p",{children:"Initialize Node.js Project:"}),e[8]=u,e[9]=m,e[10]=h):(u=e[8],m=e[9],h=e[10]);let x;e[11]===Symbol.for("react.memo_cache_sentinel")?(x=t.jsxs("li",{children:["Generate package.json (project metadata & dependencies):",t.jsx(re,{parts:[{type:"text",text:"npm init -y"}]})]}),e[11]=x):x=e[11];let g,S;e[12]===Symbol.for("react.memo_cache_sentinel")?(g=t.jsxs("ul",{className:"list-disc ml-5",children:[x,t.jsxs("li",{children:["Verify installation This creates a package.json file with default values and now add the below scripts in the file.",t.jsx(ne,{src:at,alt:"node & npm versions"})]})]}),S=s(4),e[12]=g,e[13]=S):(g=e[12],S=e[13]);let k;e[14]===Symbol.for("react.memo_cache_sentinel")?(k=t.jsx("b",{children:"public (for serving static assets), src"}),e[14]=k):k=e[14];let y;e[15]===Symbol.for("react.memo_cache_sentinel")?(y=t.jsx("b",{children:"src"}),e[15]=y):y=e[15];let b,j,_,w;e[16]===Symbol.for("react.memo_cache_sentinel")?(b=t.jsxs("p",{children:["In the root of the project now create a folder named ",k,", inside ",y," folder create folders named ",t.jsx("b",{children:" config, controllers, services/middlewares, models, routes "})," ."]}),j=t.jsx("p",{children:" Now create a file named index.js inside the src folder this is the entry point of the project."}),_=s(5),w=t.jsx("p",{children:"Now install the required dependencies/packages. "}),e[16]=b,e[17]=j,e[18]=_,e[19]=w):(b=e[16],j=e[17],_=e[18],w=e[19]);let N,I,v,f;e[20]===Symbol.for("react.memo_cache_sentinel")?(N=t.jsx(re,{parts:[{type:"text",text:"npm i express mongoose dotenv bcrypt jsonwebtoken"}]}),I=s(6),v=t.jsx("p",{children:"Now create a db.js file inside the config folder and write the below code inside it."}),f=t.jsx(ne,{src:it,alt:"mongoose connection"}),e[20]=N,e[21]=I,e[22]=v,e[23]=f):(N=e[20],I=e[21],v=e[22],f=e[23]);let C,R,P,T;e[24]===Symbol.for("react.memo_cache_sentinel")?(C=t.jsx(re,{parts:[{type:"text",text:ae?.connectionFile}]}),R=s(7),P=t.jsx("p",{children:"Now create a User.js file inside the models folder."}),T=t.jsx(ne,{src:ct,alt:"User model"}),e[24]=C,e[25]=R,e[26]=P,e[27]=T):(C=e[24],R=e[25],P=e[26],T=e[27]);let D,O,U,q;e[28]===Symbol.for("react.memo_cache_sentinel")?(D=t.jsx(re,{parts:[{type:"text",text:ae?.modelFile}]}),O=s(8),U=t.jsx("p",{children:"Now create a authController.js file inside the controllers folder."}),q=t.jsx(ne,{src:mt,alt:"controllers"}),e[28]=D,e[29]=O,e[30]=U,e[31]=q):(D=e[28],O=e[29],U=e[30],q=e[31]);let E,F,B,M;e[32]===Symbol.for("react.memo_cache_sentinel")?(E=t.jsx(re,{parts:[{type:"text",text:ae?.controller}]}),F=s(9),B=t.jsx("p",{children:"Now create a authMiddleware.js file inside the middleware folder."}),M=t.jsx(ne,{src:dt,alt:"middleware"}),e[32]=E,e[33]=F,e[34]=B,e[35]=M):(E=e[32],F=e[33],B=e[34],M=e[35]);let G,z,H,A;e[36]===Symbol.for("react.memo_cache_sentinel")?(G=t.jsx(re,{parts:[{type:"text",text:ae?.middleware}]}),z=s(10),H=t.jsx("p",{children:"Now create a authRoutes.js file inside the routes folder."}),A=t.jsx(ne,{src:pt,alt:"routes"}),e[36]=G,e[37]=z,e[38]=H,e[39]=A):(G=e[36],z=e[37],H=e[38],A=e[39]);let L,W,V,J;e[40]===Symbol.for("react.memo_cache_sentinel")?(L=t.jsx(re,{parts:[{type:"text",text:ae?.routes}]}),W=s(11),V=t.jsx("p",{children:"Now write the below code inside the inde.jx file."}),J=t.jsx(ne,{src:xt,alt:"routes"}),e[40]=L,e[41]=W,e[42]=V,e[43]=J):(L=e[40],W=e[41],V=e[42],J=e[43]);let X,Y,K;e[44]===Symbol.for("react.memo_cache_sentinel")?(X=t.jsx(re,{parts:[{type:"text",text:ae?.indexFile}]}),Y=s(12),K=t.jsx("p",{children:"Now create a .env file in the root of the project with below variables."}),e[44]=X,e[45]=Y,e[46]=K):(X=e[44],Y=e[45],K=e[46]);let Q,Z;e[47]===Symbol.for("react.memo_cache_sentinel")?(Q=t.jsxs("ul",{className:" list-disc ml-5",children:[t.jsx("li",{children:"PORT=3000 # or any port of your choice"}),t.jsx("li",{children:'JWT_EXPIRES_IN="7d"  # or any duration of your choice'}),t.jsx("li",{children:" JWT_SECRET='#GY6890rf3' # or any secret of your choice "}),t.jsx("li",{children:'MONGODB_URI="mongodb://localhost:27017/dbName" #get the db connection string either from the mongodb Atlas or from the local machine (Compass).'})]}),Z=t.jsx(ne,{src:ht,alt:"routes"}),e[47]=Q,e[48]=Z):(Q=e[47],Z=e[48]);let ee,te,se;e[49]===Symbol.for("react.memo_cache_sentinel")?(ee=t.jsx(re,{parts:[{type:"text",text:`${ae?.mongoURI}/`},{type:"placeholder",text:"dbName"}]}),te=s(13),se=t.jsx("p",{children:"Now run the below command to run the project"}),e[49]=ee,e[50]=te,e[51]=se):(ee=e[49],te=e[50],se=e[51]);let oe;e[52]===Symbol.for("react.memo_cache_sentinel")?(oe=t.jsx(re,{parts:[{type:"text",text:"npm run dev"}]}),e[52]=oe):oe=e[52];let le;return e[53]===Symbol.for("react.memo_cache_sentinel")?(le=t.jsxs("div",{className:"max-w-7xl mx-auto px-6 py-8 grid grid-cols-12 gap-8",children:[t.jsxs("div",{className:"col-span-12 lg:col-span-8 space-y-6",children:[o,n,r,l,a,d,c,m,h,u,g,S,b,j,_,w,N,I,v,f,C,R,P,T,D,O,U,q,E,F,B,M,G,z,H,A,L,W,V,J,X,Y,K,Q,Z,ee,te,se,oe,t.jsxs("p",{children:["Now you can access your project over the ",t.jsx("span",{onClick:_t,className:"text-brand-primary hover:text-brand-secondary cursor-pointer",children:"http://localhost:3000"})," URL"]})]}),t.jsx(ut,{steps:gt})]}),e[53]=le):le=e[53],le};function bt(e){return t.jsx(ft,{stepNum:e})}function jt(){return window.open("https://nodejs.org/en","_blank")}function _t(){return window.open("http://localhost:3000","_blank")}const wt="/blogs/assets/thumbnail-D7LF9_-8.png",St="/blogs/assets/img1-BWEMyH3F.png",kt="/blogs/assets/img2-Sm8dx4Pe.png",Nt="/blogs/assets/img3-DtWt-fVO.png",{Code:p,Image:Fe,Sidebar:vt,Step:Ct}=qe,$t=[{name:"Install docker"},{name:"Check installed docker version"},{name:"Create docker image of project"},{name:"Push image to the docker hub"},{name:"Docker container commands"},{name:"Docker images commands"}],Be={dockerFile:`# Use official Python 3.13 slim image
...
pm2 startup`}]}),v=s(4),f=t.jsx("h3",{className:"text-xl font-semibold text-text-main",children:"Nginx Configuration (Backend Proxy)"}),C=t.jsx("p",{children:"First, check if your domain is pointing to the server IP."}),e[21]=I,e[22]=v,e[23]=f,e[24]=C):(I=e[21],v=e[22],f=e[23],C=e[24]);let R,P;e[25]===Symbol.for("react.memo_cache_sentinel")?(R=t.jsx($,{parts:[{type:"text",text:"ping "},{type:"placeholder",text:"example.com"}]}),P=t.jsx("p",{className:"mt-4",children:"Create a new site configuration:"}),e[25]=R,e[26]=P):(R=e[25],P=e[26]);let T,D;e[27]===Symbol.for("react.memo_cache_sentinel")?(T=t.jsx($,{parts:[{type:"text",text:"sudo nano /etc/nginx/sites-available/"},{type:"placeholder",text:"example.com"}]}),D=t.jsx("p",{className:"mt-4",children:"Paste the following configuration (adjust the port):"}),e[27]=T,e[28]=D):(T=e[27],D=e[28]);let O,U,q;e[29]===Symbol.for("react.memo_cache_sentinel")?(O=t.jsx($,{parts:[{type:"text",text:`server {
    ...
    root `},{type:"placeholder",text:"/var/www/project-path/buildFolder"},{type:"text",text:`;
    index index.html;
